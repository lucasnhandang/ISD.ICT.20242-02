...
public class NormalOrderService {
    ...
    public NormalOrderService(InvoiceCalculationService invoiceCalculationService, @Qualifier("standardShippingFee") ShippingFeeCalculator shippingFeeCalculator) {
