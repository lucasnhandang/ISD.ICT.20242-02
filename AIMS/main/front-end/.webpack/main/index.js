...
const createWindow = () => {
    ...
    mainWindow = new electron_1.BrowserWindow({
        ...
        width: 1200,
        webPreferences: {
            preload: 'D:\\2024.2\\ISD.ICT.20242-02\\AIMS\\main\\front-end\\.webpack\\renderer\\main_window\\preload.js',
...
const mockUsers = [
    { email: 'admin@aims.com', password: 'admin123', role: 'Admin' },
    { email: 'manager@aims.com', password: 'manager123', role: 'Product Manager' },
];
// Handle IPC events
electron_1.ipcMain.handle('login', async (_, role, credentials) => {
    console.log(`Login attempt as ${role}`, credentials);
    // For customer, we allow direct access without credentials
    if (role === 'Customer') {
        currentUser = { email: 'customer@aims.com', role: 'Customer' };
        return { success: true, user: currentUser };
    }
    // For Admin and Product Manager, check credentials
